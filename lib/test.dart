...
//         ),
//         childrenPadding:
//             const EdgeInsets.all(16), // Padding for the expanded content
//         backgroundColor: backgroundColor, // Background color when expanded
//         collapsedBackgroundColor:
//             Colors.white, // Background color when collapsed
//         textColor: Colors.blue, // Text color when expanded
//         collapsedTextColor: Colors.black, // Text color when collapsed
